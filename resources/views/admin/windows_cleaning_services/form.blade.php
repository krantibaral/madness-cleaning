<div class="form-group row">
    ...
    <div class="col-md-6 mt-4">
        ...
        <input type="number" required class="form-control" name="number_of_windows"
            value="{{ old('number_of_windows', $item->number_of_windows ?? '') }}">
    </div>
    ...
    <div class="col-md-6 mt-4">
        ...
        <select class="form-control" name="windows_track_frame">
            <option value="Track"
                {{ old('windows_track_frame', $item->windows_track_frame ?? '') == 'Track' ? 'selected' : '' }}>Track
            </option>
            <option value="Frame"
                {{ old('windows_track_frame', $item->windows_track_frame ?? '') == 'Frame' ? 'selected' : '' }}>Frame
            </option>
            <option value="Both"
                {{ old('windows_track_frame', $item->windows_track_frame ?? '') == 'Both' ? 'selected' : '' }}>Both
            </option>
        </select>
    </div>
    <div class="col-md-6 mt-4">
